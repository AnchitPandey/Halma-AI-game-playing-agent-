...
/*
   ...
   */
   ...
   /*            
    ...
    //    System.out.println("i am at "+ arrayY +","+ arrayX);
        ...
        {
            String bachhaString = parentString+"J "+ String.valueOf(arrayY)+","+ String.valueOf(arrayX)+" "+String.valueOf(arrayY-2)+","+ String.valueOf(arrayX-2);
       ...
       //       moves.add (parentString);
         ...
         //  jumpMovesInitial(colour, board, arrayX-2, arrayY-2, moves,origX,origY, parentString,visited, homeComing, startTime, initialTimeLimit);
          jumpMovesInitial(colour, board, arrayX-2, arrayY-2, moves,origX,origY, bachhaString,visited, homeComing, startTime, initialTimeLimit);
         currentTime = System.currentTimeMillis();
     ...
     // checking north direction 
        ...
        {
            String bachhaString = parentString+"J "+ String.valueOf(arrayY)+","+ String.valueOf(arrayX)+" "+String.valueOf(arrayY)+","+ String.valueOf(arrayX-2);
          // parentString += "J "+ String.valueOf(arrayY)+","+ String.valueOf(arrayX)+" "+String.valueOf(arrayY)+","+ String.valueOf(arrayX-2);
           ...
           jumpMovesInitial(colour, board, arrayX-2, arrayY, moves,origX,origY, bachhaString,visited, homeComing, startTime, initialTimeLimit);
           currentTime = System.currentTimeMillis();
           if (currentTime - startTime >= initialTimeLimit-0.5)
             return moves;  
        }     
     ...
     // checking west direction
        ...
        {
            String bachhaString = parentString + "J "+ String.valueOf(arrayY)+","+ String.valueOf(arrayX)+" "+String.valueOf(arrayY-2)+","+ String.valueOf(arrayX);
          ...
          jumpMovesInitial(colour, board, arrayX, arrayY-2, moves,origX,origY, bachhaString,visited, homeComing, startTime, initialTimeLimit);
          currentTime = System.currentTimeMillis();
        if (currentTime - startTime >= initialTimeLimit-0.5)
            return moves;
...
//           jumpMovesInitial(colour, board, arrayX+2, arrayY, moves,origX,origY, parentString,visited, homeComing,startTime, initialTimeLimit);
   jumpMovesInitial(colour, board, arrayX+2, arrayY, moves,origX,origY, bachhaString,visited, homeComing,startTime, initialTimeLimit);
        ...
        {
            String bachhaString = parentString + String.valueOf(arrayY)+","+ String.valueOf(arrayX)+" "+String.valueOf(arrayY+2)+","+ String.valueOf(arrayX+2);
           // parentString += "J "+ String.valueOf(arrayY)+","+ String.valueOf(arrayX)+" "+String.valueOf(arrayY+2)+","+ String.valueOf(arrayX+2);
            if (manhattanDistanceFromOwnGoal(arrayX+2, arrayY+2, colour) > manhattanDistanceFromOwnGoal(origX, origY, colour) || (manhattanDistanceFromOwnGoal(arrayX+2, arrayY+2, colour) == manhattanDistanceFromOwnGoal(origX, origY, colour) && !homeComing.containsKey(String.valueOf(arrayX+2)+","+String.valueOf(arrayY+2))))
          //      moves.add (parentString);
              moves.add (bachhaString);
...
currentTime = System.currentTimeMillis();
        ...
        if (arrayY-2 >=0 && board[arrayX][arrayY-2] =='.' && board[arrayX][arrayY-1]!='.' &&!visited.containsKey(String.valueOf(arrayX) + ","+String.valueOf(arrayY-2)))    
        {
            String bachhaString = "J "+ String.valueOf(arrayY)+","+ String.valueOf(arrayX)+" "+String.valueOf(arrayY-2)+","+ String.valueOf(arrayX);
         //  parentString += "J "+ String.valueOf(arrayY)+","+ String.valueOf(arrayX)+" "+String.valueOf(arrayY-2)+","+ String.valueOf(arrayX);
           if (manhattanDistanceFromOwnGoal(arrayX, arrayY-2, colour) > manhattanDistanceFromOwnGoal(origX, origY, colour) || (manhattanDistanceFromOwnGoal(arrayX, arrayY-2, colour) == manhattanDistanceFromOwnGoal(origX, origY, colour) && !homeComing.containsKey(String.valueOf(arrayX)+","+String.valueOf(arrayY-2))))
           //   moves.add (parentString);
               moves.add (bachhaString);
 ...
 currentTime = System.currentTimeMillis();
  ...
  //         jumpMovesInitial(colour, board, arrayX-2, arrayY+2, moves,origX,origY, parentString,visited, homeComing, startTime, initialTimeLimit);
    ...
    //    opponentAreaMoves(colour, board, arrayX-2, arrayY-2, moves,origX,origY, parentString,visited, startTime, initialTimeLimit, goalCoords);
     opponentAreaMoves(colour, board, arrayX-2, arrayY-2, moves,origX,origY, bachhaString,visited, startTime, initialTimeLimit, goalCoords);  
    currentTime = System.currentTimeMillis();
               if (currentTime - startTime >= initialTimeLimit-0.5)
                   return moves;     
        }
     ...
     // checking north direction 
        if (arrayX -2 >=0 &&  board[arrayX-2][arrayY] =='.' && board[arrayX-1][arrayY]!='.' &&!visited.containsKey(String.valueOf(arrayX-2) +","+ String.valueOf(arrayY)))    
        {
         ...
         opponentAreaMoves(colour, board, arrayX-2, arrayY, moves,origX,origY, bachhaString,visited,startTime,initialTimeLimit, goalCoords);
         currentTime = System.currentTimeMillis();
          if (currentTime - startTime >= initialTimeLimit-0.5)
            return moves;      
        ...
        if (arrayY-2 >=0 && board[arrayX][arrayY-2] =='.' && board[arrayX][arrayY-1]!='.' &&!visited.containsKey(String.valueOf(arrayX) + ","+String.valueOf(arrayY-2)))    
        {
          ...
          // parentString += "J "+ String.valueOf(arrayY)+","+ String.valueOf(arrayX)+" "+String.valueOf(arrayY-2)+","+ String.valueOf(arrayX);
           ...
           opponentAreaMoves(colour, board, arrayX, arrayY-2, moves,origX,origY, bachhaString,visited,startTime, initialTimeLimit, goalCoords);
           currentTime = System.currentTimeMillis();
               if (currentTime - startTime >= initialTimeLimit-0.5)
                   return moves;     
        }
...
//        jumpMovesOutsideHome(colour, board, arrayX-2, arrayY-2, moves,origX,origY, parentString,visited, homeComing,startTime, initialTimeLimit);
 jumpMovesOutsideHome(colour, board, arrayX-2, arrayY-2, moves,origX,origY, bachhaString,visited, homeComing,startTime, initialTimeLimit);  
currentTime = System.currentTimeMillis();
               if (currentTime - startTime >= initialTimeLimit-0.5)
                   return moves;
        }
 ...
 //         jumpMovesOutsideHome(colour, board, arrayX-2, arrayY, moves,origX,origY, parentString,visited, homeComing, startTime,initialTimeLimit);
        jumpMovesOutsideHome(colour, board, arrayX-2, arrayY, moves,origX,origY, bachhaString,visited, homeComing, startTime,initialTimeLimit);  
        currentTime = System.currentTimeMillis();
          if (currentTime - startTime >= initialTimeLimit-0.5)
            return moves; 
        }     
 ...
 //             moves.add (parentString);
        ...
        bachhaString += "\n";
         //  jumpMovesOutsideHome(colour, board, arrayX, arrayY-2, moves,origX,origY, parentString,visited, homeComing,startTime, initialTimeLimit);
           jumpMovesOutsideHome(colour, board, arrayX, arrayY-2, moves,origX,origY, bachhaString,visited, homeComing,startTime, initialTimeLimit); 
         currentTime = System.currentTimeMillis();
               if (currentTime - startTime >= initialTimeLimit-0.5)
                   return moves;
        }
...
//                moves.add (parentString);
 ...
 //         System.out.println("Not all pawns out");
        ...
        ArrayList<String> availableMoves = sortInitial(removePawnsFromHomeMoves, board, colour);
             // order the move that lead the pawn out of the area
            ArrayList<String> merger = new ArrayList<String>();
            HashMap<String, Integer> homeMap = homeCoordsHashMap(colour);
            
            for(int i =0;i< availableMoves.size();i++)
            {
                String[] lineSplitter = availableMoves.get(i).split("\n");
                String finalLine = lineSplitter[lineSplitter.length-1];
                String[] spaceSplitter = finalLine.split("\\s+");
                String[] commaSplitter = spaceSplitter[2].split(",");
                int finalX = Integer.parseInt(commaSplitter[1]);
                int finalY = Integer.parseInt(commaSplitter[0]);
                String vela = finalX+" "+ finalY;
                if (!homeMap.containsKey(vela))
                {
                    
                merger.add (availableMoves.get(i));
            ...
            for (int i = merger.size()-1; i>=0;i--)
            {
                availableMoves.add (0,merger.get(i));  
            }
           ...
           BufferedWriter writer = new BufferedWriter(new FileWriter(file));
           String validMove = availableMoves.get(0);
        //   System.out.println("valid move is: ");
